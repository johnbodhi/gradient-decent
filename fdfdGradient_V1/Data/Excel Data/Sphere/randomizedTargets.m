function [ Y ] = randomizedTargets( dataSet, Nr, Mr, L, C, N )
    ...
    if ( isfile( 'randomizedFields.csv' ) )
    
        Y = readmatrix('randomizedFields.csv');
        ...
        writematrix( randomizedPhotos, 'randomizedFields.csv' );               
    end    
end