...
function plotDist()
    ...
    subplot(3,1,1);
    plot(T(1:1:256),RA(7,:,k),T(1:1:256),RA(8,:,k));
    ...
    subplot(3,1,2);
    plot(T(1:1:256),RA(7,:,k),T(1:1:256),flip(RA(8,:,k),2));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    subplot(3,1,1);
    plot(T(1:1:256),RA(5,:,k),T(1:1:256),RA(6,:,k));
    ...
    subplot(3,1,2);
    plot(T(1:1:256),RA(5,:,k),T(1:1:256),flip(RA(6,:,k),2));
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    subplot(3,1,1);
    plot(T(1:1:256),RA(3,:,k),T(1:1:256),RA(4,:,k));
    ...
    subplot(3,1,2);
    plot(T(1:1:256),RA(3,:,k),T(1:1:256),flip(RA(4,:,k),2));
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    subplot(3,1,1);
    plot(T(1:1:256),RA(1,:,k),T(1:1:256),RA(2,:,k));
    ...
    subplot(3,1,2);
    plot(T(1:1:256),RA(1,:,k),T(1:1:256),flip(RA(2,:,k),2));
