...
open( unit = 10, file = 'R.txt', action = 'readwrite' )
open( unit = 20, file = 'G.txt', action = 'readwrite' )
open( unit = 30, file = 'B.txt', action = 'readwrite' )
open( unit = 40, file = 'Z.txt', action = 'readwrite' )
